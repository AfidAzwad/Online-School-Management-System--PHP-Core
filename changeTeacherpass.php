...
{
  header("Location: changeTeacherpass.php");
}


$conPass = $uPass = $message = " ";

$olduName = $_SESSION["t_id"];
...
<html>
  ...
  <img src="ISD.jpg" alt="ISD_logo" width="100px"></img><br><br>
	...
	<form action="changeTeacherpass.php" method="post">
  ...
  <br>
  <div align = "right">
         <button style="margin-right:16%;" class="btn btn-info" onclick="window.location.href = 'teacher.php';">Back to Profile</button>
  		</div>
