<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    $sql = "DELETE FROM library WHERE book_id = '$bookID' ";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta charset="utf-8">
    <h1 align = "center"><u>Remove Book</u></h1>
 </head>
...
<body style="background-color:lightblue">
  ...
  <div align="left" style="margin-left: 25%;">
    ...
    <input type="text" name ="bookname" id ="bookname" readonly>
      ...
      <button style ="height:30px; width:90px" type="submit" name="update" value="update" id="button">Remove</button>
      <br>
      <br>
        <span style="color:red; margin-left:50%"><?php echo $message ?> </span>
        </p>
   ...
   <input type="text" name ="Search" placeholder="search by ID/Name" class="form-control" value="">
    ...
    <table id="table" border=".5" width = "30%" height = "50%">
      ...
      <tr>
<th align="center" style="width:120px;">Book Id</th>
<th align="center" style="width:350px;">Book Name</th>
<th align="center" style="width:120px;">Status</th>
</tr>
